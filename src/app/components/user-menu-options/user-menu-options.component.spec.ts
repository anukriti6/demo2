...
import { MockRoutes } from 'src/app/mocks/MockRoutes';
...
describe('UserMenuOptionsComponent - Login menus', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [UserMenuOptionsComponent],
      providers: [
  ...
  beforeEach(() => {
    ...
    locateURL = TestBed.inject(Location);
  });
  ...
  it('#login menus and its routing', fakeAsync(() => {
  ...
  it('#admin menus and its routing', fakeAsync(() => {
